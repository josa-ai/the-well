  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        "border-border bg-white/80 backdrop-blur-sm shadow-[0_2px_8px_rgba(27,77,110,0.04)]",
    ...
    >
      ...
      <div className="relative z-10 flex flex-col gap-2">
        <h3 className="font-semibold text-base text-text tracking-tight font-[family-name:var(--font-inter)]">
          {item.title}
        </h3>
        <p className="text-base text-text-muted leading-relaxed font-[family-name:var(--font-inter)]">
          {item.description}
        </p>
      </div>
  ...
  return (
    ...
    >
      ...
      <div className="relative mb-8 flex flex-col gap-1.5">
        <p className="font-semibold text-base text-secondary uppercase tracking-[0.22em] font-[family-name:var(--font-inter)]">
          {eyebrow}
        </p>
        <h2 className="font-bold text-2xl text-text tracking-tight font-[family-name:var(--font-playfair)]">
          {heading}
        </h2>
      </div>
